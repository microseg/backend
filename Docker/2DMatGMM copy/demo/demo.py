...
def arg_parse() -> dict:
    ...
    parser.add_argument("--input", dest="input", help="Input directory containing images to process", default="demo/images", type=str)
    parser.add_argument("--num_image", dest="num_image", help="Number of images to process", default=20, type=int)
    parser.add_argument("--material", dest="material", help="Material to process", default="Graphene", type=str)
    parser.add_argument("--size", dest="size", help="Size threshold in pixels", default=500, type=int)
    parser.add_argument("--std", dest="std", help="Standard deviation threshold", default=5, type=float)
    parser.add_argument("--min_confidence", dest="min_confidence", help="The Confidence threshold", default=0.6, type=float)
...
FP_DETECTOR_PATH = os.path.join(FILE_DIR, "..", "FalsePositiveDetector", "models", "classifier_L2_logistic.joblib")
